      ...
      floatingActionButton: Column(
        ...
        children: [
          FloatingActionButton(
            heroTag: 'noticeboard',
            backgroundColor: const Color.fromARGB(255, 175, 57, 57),
            elevation: 3,
            onPressed: () => context.push('/noticeboard'),
            child: Stack(
              clipBehavior: Clip.none,
              children: [
                const Icon(Icons.campaign_outlined,
                    color: Color.fromARGB(255, 235, 234, 234), size: 26),
                Positioned(
                  top: -2,
                  right: -2,
                  child: Container(
                    ...
                    decoration: const BoxDecoration(
                        color: Color(0xFFE30613), shape: BoxShape.circle),
                  ),
                ),
              ],
            ),
